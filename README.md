В данном репозитории размещена информация о синтаксисе языка разметки Markdown с примерами,  
а также в файле **README-Template.md** находится качественный шаблон Readme.md файла для описания проекта.

Генератор Readme в реальном времени: https://dillinger.io/
